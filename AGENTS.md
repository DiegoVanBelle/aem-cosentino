...
- Vanilla blocks use JavaScript (ES6+) and CSS3 without transpilation.
- Optional React islands compile JSX and locally built, `tw:`-prefixed Tailwind utilities; no global Preflight reset.
